...
#     models.DetailInfo.objects.create(amount=amount, type=type, generation=generation,role=role1)
#
#     role1 = RoleInfo.objects.get(id=RoleInfo_id)
#     detail_list = role1.detailinfo_set.all()
#     context = {
#         'amount': amount, 'type': type, 'generation': generation, 'detail_list': detail_list, 'role': role,
#
#     }
#     return render(request, 'Seed/postTest2.html', context)
#
